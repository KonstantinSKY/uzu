...
pub fn uzu_config_abstract(
    ...
    let Fields::Named(FieldsNamed {
        ...
        return syn::Error::new(input.fields.span(), "uzu_config_abstract requires a struct with named fields")
            .to_compile_error()
            .into();
    };
...
pub fn uzu_config(
    ...
    if !args.is_empty() {
        ...
        let Data::Struct(DataStruct {
            ...
            return syn::Error::new(input.span(), "uzu_config(Abstract) requires a struct with named fields")
                .to_compile_error()
                .into();
        };
